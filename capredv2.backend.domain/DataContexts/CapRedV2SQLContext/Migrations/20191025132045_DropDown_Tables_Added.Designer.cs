...
namespace capredv2.backend.domain.DataContexts.CapRedV2SQLContext.Migrations
{
    ...
    [Migration("20191025132045_DropDown_Tables_Added")]
    partial class DropDown_Tables_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.AssetCategory", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("AssetCategorys");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.BudgetItemType", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.BusinessDriver", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.BusinessJustification", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("BusinessJustifications");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.BusinessRisk", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.CapitalOrExpense", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("CapitalOrExpenses");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ChangeOrderReason", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("ChangeOrderReasons");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.CipOrNonCip", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("CipOrNonCips");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.CostCodeLevel1", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("CostCodeLevel1s");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.CostCodeLevel2", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("CostCodeLevel2s");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.FacilityType", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.FiscalYear", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ItemCategory", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ItemStatus", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.LeasedOrOwned", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("LeasedOrOwneds");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.Milestones", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.PlanProjectOrEmerging", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("PlanProjectOrEmergings");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ProjectTheme", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ProjectType", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.RealEstateOrBau", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("RealEstateOrBaus");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.Region", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.ReportingMilestones", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("ReportingMilestones");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.RequiredOrDiscretionary", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("RequiredOrDiscretionaries");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.RestorationRequirement", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("RestorationRequirements");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.RolloverCategory", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("RolloverCategories");
                });

            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Dropdowns.WorkPackagesLevel1", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Projects.RequisitionHeader", b =>
                {
                    b.Property<Guid>("Id");
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Projects.RequisitionLineItem", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.Property<Guid>("RequisitionHeaderId");

                    b.Property<int>("RequisitionLineNumber");
                    ...
                    b.HasIndex("RequisitionHeaderId");

                    b.ToTable("RequisitionLineItems");
                });
            ...
            modelBuilder.Entity("capredv2.backend.domain.DatabaseEntities.Projects.RequisitionLineItem", b =>
                {
                    b.HasOne("capredv2.backend.domain.DatabaseEntities.Projects.RequisitionHeader", "RequisitionHeader")
                        .WithMany("RequisitionLineItems")
                        .HasForeignKey("RequisitionHeaderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
