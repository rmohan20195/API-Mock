...
namespace capredv2.backend.domain.tests.DatabaseEntities.Projects
{
    ...
    {
        [Test]
        public void MapFromDomainEntity_ValidEntity_ReturnValidDTOEntity()
        {
            //Arrange
            var projectInformation = new ProjectInformationDTO
            {
            ...
            //Act
            var response = ProjectInformation.MapFromDomainEntity(projectInformation);
        ...
        [Test]
        public void MapFromDomainEntity_NullEntity_ReturnNull()
        {
            //Act
            var response = ProjectInformation.MapFromDomainEntity(null);
