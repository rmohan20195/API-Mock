...
{
    [TestFixture]
    public class RolloverCategoryTests
    {
        ...
        {
            //Arrange
            var rolloverCategory = new RolloverCategoryDTO()
            {
                Id = Guid.NewGuid(),
                Value = "Pending Submission",
                Position = 0
            };
            var response = RolloverCategory.MapFromDomainEntity(rolloverCategory);
        ...
        {
            //Act
            var response = RolloverCategory.MapFromDomainEntity(null);
