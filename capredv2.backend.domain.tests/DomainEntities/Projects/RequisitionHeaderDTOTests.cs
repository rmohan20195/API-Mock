...
{
    public class RequisitionHeaderDTOTests
    {
        [Test]
        public void MapFromDomainEntity_ValidEntity_ReturnDTOEntity()
        {
            //Arrange
            var requisition = new RequisitionHeader
            {
            ...
            //Act
            var response = RequisitionHeaderDTO.MapFromDatabaseEntity(requisition);
        ...
        {
            //Act
            var response = RequisitionHeaderDTO.MapFromDatabaseEntity(null);
